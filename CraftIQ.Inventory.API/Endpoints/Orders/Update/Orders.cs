...
{
    public class Orders(InventoryFactory<OrdersOperationContract, dynamic> factory) : EndpointsAsync.WithRequest<UpdateOrderRequest>
                                                                                                 .WithActionResult
    {
        private readonly InventoryFactory<OrdersOperationContract, dynamic> _factory = factory;
        ...
        public override async Task<ActionResult> HandleAsync([FromMultiSource] UpdateOrderRequest request, CancellationToken cancellationToken = default)
        {
            ...
            var oData = new OrdersOperationContract(request.orderId,
