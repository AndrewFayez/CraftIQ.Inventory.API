...
{
    public class Orders(InventoryFactory<OrdersOperationContract, OrdersContract> factory) : EndpointsAsync.WithRequest<CreateOrderRequest>
                                                                                                           .WithActionResult<CreateOrderResponse>
    {
        private readonly InventoryFactory<OrdersOperationContract, OrdersContract> _factory = factory;
        ...
        public override async Task<ActionResult<CreateOrderResponse>> HandleAsync([FromBody] CreateOrderRequest request, CancellationToken cancellationToken = default)
        {
            ...
            var oData = new OrdersOperationContract(Guid.Empty,
                                                     request.SupplierId,
                                                     request.OrderDate,
                                                     request.TotalAmount,
                                                     request.Status,
