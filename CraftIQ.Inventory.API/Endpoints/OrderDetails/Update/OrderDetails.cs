...
namespace CraftIQ.Inventory.API.Endpoints.OrderDetails.Update
{
    public class OrderDetails(InventoryFactory<OrderDetailsOperationContract, dynamic> factory) : EndpointsAsync.WithRequest<UpdateOrderDetailRequest>
                                                                                                            .WithActionResult
    {
        private readonly InventoryFactory<OrderDetailsOperationContract, dynamic> _factory = factory;
        ...
        public override async Task<ActionResult> HandleAsync([FromMultiSource] UpdateOrderDetailRequest request, CancellationToken cancellationToken = default)
        {
            ...
            var oData = new OrderDetailsOperationContract(request.orderDetailId,
